...
from config import POSITIONS_FILE, TH_PROFIT_TARGET_PCT, STOP_LOSS_PCT
...
def check_exit_conditions(positions: List[Dict]) -> List[Dict]:
    ...
    for pos in positions:
        ...
        try:
            ...
            if current_mid <= credit * (1 - TH_PROFIT_TARGET_PCT):
                pos["exit_signal"] = f"profit_target ({TH_PROFIT_TARGET_PCT:.0%})"
